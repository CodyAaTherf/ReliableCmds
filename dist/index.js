...
var ReliableCmds = /** @class */ (function () {
    function ReliableCmds(client, commandsDir, listenerDir) {
        ...
        this._mongo = '';
        this._syntaxError = 'Syntax Error: {PERFIX}{COMMAND}{ARGUMENTS}';
        this._prefixes = {};
        if (!client) {
        ...
        if (module && module.parent) {
            ...
            if (path_2) {
                commandsDir = "".concat(path_2, "/").concat(this._commandsDir);
                if (listenerDir) {
                    listenerDir = "".concat(path_2, "/").concat(listenerDir);
                }
            }
        }
    ...
    Object.defineProperty(ReliableCmds.prototype, "syntaxError", {
        get: function () {
    ...
    ReliableCmds.prototype.setSyntaxError = function (syntaxError) {
    ...
    ReliableCmds.prototype.setPrefix = function (guild, prefix) {
        if (guild) {
            this._prefixes[guild.id] = prefix;
        }
    };
    Object.defineProperty(ReliableCmds.prototype, "commandHandler", {
        get: function () {
